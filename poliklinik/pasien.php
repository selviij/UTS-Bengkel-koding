...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_GET['page']) && $_GET['page'] == 'pasien') {
...
// Jika ada parameter 'id' di URL, ambil data pasien yang sesuai
if (isset($_GET['id'])) {
    $id = $_GET['id'];
...
<body>
    <div class="container mt-5">
        <form action="index.php?page=pasien" method="post" enctype="multipart/form-data">
